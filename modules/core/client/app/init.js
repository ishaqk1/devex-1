(function (app) {
  ...
  function bootstrapConfig($compileProvider, $locationProvider, $httpProvider, $logProvider, $uiViewScrollProvider, $translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      DEPTS_P2: 'Other federal departments who wish to use the GC Dev Ex Beta can contact xxxxx. Once evaluated, the initiative may be expanded.',
    ...
    .translations('fr', {
      ...
      DEPTS_P2: 'Les autres ministères fédéraux qui souhaitent utiliser le CarrefourProgGC bêta peuvent communiquer avec xxxxx. L\'initiative pourrait être étendue, une fois l\'évaluation nécessaire effectuée.',
      ...
      CODE_P3: 'Que vous fassiez partie d\'un gouvernement provincial, d\'une administration municipale ou d\'un gouvernement national à l\'étranger, vous pouvez copier le code sur GitHub et établir votre propre plateforme de microapprovisionnement afin de travailler avec les développeurs de votre communauté.',
      IMG_CAP1: '',
      IMG_CAP2: '',
      IMG_CAP3: '',
