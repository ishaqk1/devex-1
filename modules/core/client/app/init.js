(function (app) {
  ...
  function bootstrapConfig($compileProvider, $locationProvider, $httpProvider, $logProvider, $uiViewScrollProvider, $translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      OPP_FIXED_PRICE: 'This is a <strong>fixed-price</strong> opportunity governed by the <a href="https://github.com/canada-ca/devex/blob/master/GCDevExchange_-_Terms_and_Conditions.pdf">terms</a> of our lightweight procurement model.',
      ...
      OPP_INSTRUCTIONS: 'With your proposal, you must upload a copy of the <a href="https://github.com/canada-ca/devex/blob/master/GCDevExchange_-_Terms_and_Conditions.pdf">terms,</a> to indicate your acceptance of the terms.',
      ...
      OPP_EDIT_P2: 'By posting an opportunity on the GCDevExchange, you are agreeing to the following <a href="https://github.com/canada-ca/devex/blob/master/GCDevExchange_-_Terms_and_Conditions.pdf">Terms</a>. Make sure you are familiar with the process and understand your responsibilities for managing an opportunity.',
    ...
    .translations('fr', {
      ...
      CODE_P3: 'Que vous fassiez partie d\'un gouvernement provincial, d\'une administration municipale ou d\'un gouvernement national à l\'étranger, vous pouvez <a href="https://github.com/canada-ca/devex">copier le code sur GitHub</a> et établir votre propre plateforme de micro-approvisionnement afin de travailler avec les développeurs de votre communauté.',
      IMG_CAP1: '',
      IMG_CAP2: '',
      IMG_CAP3: '',
      ...
      PROJECT_TITLE: 'Liste des projets',
      PROJECT_TH1: 'Titre du projet',
      PROJECT_TH2: 'Description',
      PROJECT_TH3: 'Équipe',
      PROJECT_TH4: 'Mots clés',
      PROJECT_NONE: 'Pas de projets ouverts en ce moment. Revenez bientôt!',
      ...
      EDIT_PROFILE_SUCCESS: 'Modification du profil réussie',
      EDIT_PROFILE_SUCCESS_TEXT: 'Vous avez demandé l\'accès en tant qu\'utilisateur du gouvernement; la demande est présentement affichée aux fins d\'examen. Vous recevrez l\'accès aux organismes du gouvernement et vous pourrez accéder aux fonctions de l\'utilisateur du gouvernement dès que l\'administrateur aura vérifié que vous êtes bien un utilisateur du gouvernement.',
      EDIT_PROFILE_OPPORTUNITIES: 'Nous vous enverrons les avis de nouvelles possibilités affichées sur CarrefourProgGC.',
      EDIT_PROFILE_EVENTS: 'Nous vous aviserons des activités à venir.',
      EDIT_PROFILE_BLOG: 'Nous vous aviserons des nouveaux billets de blogue.',
      EDIT_PROFILE_FAILURE: 'Modification du profil non réussie!',
      404: 'Page non trouvée!',
      403: 'Interdit!',
      400: 'Mauvaise demande',
      CHANGES_SAVED: 'Vos changements ont été enregistrés.',
      SAVE_CHANGES: 'Sauvegarder les changements',
      SAVE: 'Sauvegarder',
      CANCEL: 'Annuler',
      REMOVE: 'Supprimer',
      ARE_YOU_SURE: 'Êtes-vous certain de vouloir effectuer la suppression?',
      ...
      TEAM_SELECT: 'Choisissez l\'équipe propriétaire ou qui soutient le projet.',
      TEAM_DEPARTMENT: 'Ministère',
      TEAM_SHORT_DESCRIPTION: 'Courte description',
      TEAM_WEBSITE: 'Site Web',
      TEAM_LOGO: 'Logo de l\'équipe',
      TEAM_PICTURE: 'Sélectionner Image',
      ...
      PROJECT_NAME: 'Inscrivez le nom de votre projet. Il est préférable que le nom corresponde à celui du votre répertoire GitHub.',
      PROJECT_TEASER_LABEL: 'Courte description',
      PROJECT_TEASER: 'Il s\'agit d\'un aperçu visant à encourager les développeurs à contribuer à votre projet. Résumez les objectifs du projet, les avantages pour les utilisateurs finaux et ce qu\'il apporte aux Canadiens!',
      PROJECT_TEASER_PLACEHOLDER: 'Une courte description du projet',
      PROJECT_DETAIL: 'Vous pouvez ici présenter plus de détails...',
      PROJECT_GITHUB: 'Collez l\'URL du répertoire GitHub de ce projet.',
      PROJECT_GITHUB_PLACEHOLDER: 'Répertoire GitHub pour le projet',
      PROJECT_TAGS_LABEL: 'Étiquettes (liste d\'étiquettes délimitées par des virgules)',
      PROJECT_TAGS: 'Créez des étiquettes qui serviront d\'indications rapides à l\'intention des développeurs, p. ex. le langage de programmation ou d\'autres mots clés qui indiqueront en quoi consiste le projet.',
      PROJECT_TAGS_PLACEHOLDER: 'Liste des étiquettes',
      PROJECT_SELECT: 'Sélectionner Projet',
      PROJECT_DELETED: 'Projet supprimé avec succès!',
      OPP_NEW: 'Nouvelle possibilité',
      ...
      OPP_FIXED_PRICE: 'Il s\'agit d\'une possibilité à <strong>prix fixe</strong> régie par les modalités de notre <a href="https://github.com/canada-ca/devex/blob/master/GCDevExchange_-_Terms_and_Conditions.pdf">modèle</a> d\'approvisionnement allégé.',
      ...
      OPP_INSTRUCTIONS: 'Avec votre proposition, vous devez télécharger une copie des <a href="https://github.com/canada-ca/devex/blob/master/GCDevExchange_-_Terms_and_Conditions.pdf">termes,</a> pour indiquer votre acceptation des termes.',
      ...
      OPP_SELECT_PROJECT: 'Sélectionnez le projet dans lequel s\'inscrit cette possibilité de travail. Si vous ne trouvez pas le projet dans la liste déroulante, vous devez cliquer sur l\'onglet Projets et d\'abord créer une nouvelle page de projet.',
      OPP_SHORT_TITLE_LABEL: 'Titre',
      OPP_SHORT_TITLE: 'Inscrivez un court titre pour votre possibilité de travail qui illustre bien l\'essentiel du travail qui doit être réalisé.',
      OPP_TEASER_LABEL: 'Accroche',
      OPP_TEASER: 'Présentez une description d\'une ou deux phrases qui suscitera l\'intérêt des lecteurs et qui les encouragera à faire une offre. Décrivez ce que vous attendez d\'eux.',
      ...
      OPP_SKILLS_PLACEHOLDER: 'p. ex. JavaScript, WordPress, CSS',
      OPP_ACCEPTANCE_CRITERIA: 'La présente section sert à définir clairement tout ce qui doit être exécuté et les critères qui doivent être respectés pour que vous soyez satisfait et prêt à payer le développeur.',
      OPP_REWARD_LABEL: 'Récompense à prix fixe',
      OPP_REWARD: '<p>Estimez du mieux que vous pouvez un juste prix qui selon vous représente la quantité de travail que doit accomplir un développeur qualifié pour satisfaire aux critères d\'acceptation. Il convient de surestimer ce prix.</p><p>Pour l\'instant, les contrats offerts par la voie du Carrefour des développeurs du gouvernement du Canada (CarrefourProgGC) ne doivent pas dépasser 10 000 $.</p>',
      OPP_REWARD_AMOUNT: 'Sélectionner Montant de la récompense',
      OPP_EVALUATION_CRITERIA_LABEL: 'Critères d\'évaluation de la proposition',
      OPP_EVALUATION_CRITERIA: 'Dans cette section, vous devez explicitement décrire les critères que vous utiliserez pour établir le score des propositions que vous recevrez. Précisez la pondération ou les points accordés pour chaque critère (p. ex. « Expérience de travail avec le code Java dans le cadre de tout répertoire de code public avec plus de cinq contributeurs : 10 points »).<br/>Vous être libre d\'établir les critères obligatoires et leur pondération. Pour vous orienter, vous pouvez consulter les <a target="_blank" href="http://www2.gov.bc.ca/gov/content/governments/services-for-government/bc-bid-resources/how-to-buy-services/procurement-process/pre-award/prepare-solicitation-documents/mandatory-and-weighted-criteria">renseignements du gouvernement de la Colombie‑Britannique sur les marchés</a> (en anglais seulement).',
      OPP_EMAIL_ADDRESS_LABEL: 'Courriel pour recevoir l\'acceptation des modalités et du contrat',
      OPP_EMAIL_ADDRESS: 'Inscrivez l\'adresse courriel où vous aimeriez recevoir l\'avis d\'acceptation des conditions du CarrefourProgGC du soumissionnaire déterminé pour cette possibilité de travail.',
      OPP_EMAIL_ADDRESS_PLACEHOLDER: 'Saisir l\'adresse courriel',
      OPP_PROPOSAL_LABEL: 'Date limite pour la proposition',
      OPP_PROPOSAL_P1: 'Choisissez une <b>date limite</b> de réception des propositions. (L\'heure de la journée est fixée à 16 h – heure normale du Pacifique.)',
      OPP_PROPOSAL_P2: 'Plus longtemps d\'avance votre offre sera affichée, plus nombreuses seront les propositions que vous recevrez. Il est judicieux d\'établir la date butoir à <b>cinq jours</b> de la publication de votre possibilité de travail.',
      OPP_PROPOSAL_P3: 'Veillez à ce que votre <b>personne‑ressource</b> attitrée au contrat soit prête à répondre rapidement aux questions posées sur la page de publication GitHub, et ce, du moment de la publication à l\'heure limite de soumission.',
      OPP_ASSIGNMENT_DATE_LABEL: 'Date de l\'assignation',
      OPP_ASSIGNMENT_DATE: 'Établissez une date à laquelle vous vous engagez à attribuer le contrat (sous réserve bien entendu d\'avoir reçu au moins une proposition satisfaisant à vos exigences minimales). (L\'heure est fixée à 16 h – heure du Pacifique).',
      OPP_START_DATE_LABEL: 'Date de début proposée',
      OPP_START_DATE: 'Quand voulez-vous que la personne commence à travailler?',
      OPP_EDIT_P1: 'Gérer une possibilité dans le cadre de GCDevExchange',
      OPP_EDIT_P2: 'En affichant une possibilité sur le CarrefourProgGC, vous acceptez de respecter les <a href="https://github.com/canada-ca/devex/blob/master/GCDevExchange_-_Terms_and_Conditions.pdf">modalités</a>. Assurez-vous de connaître le processus et de comprendre vos responsabilités en matière de gestion d\'une possibilité.',
      OPP_EDIT_P3: 'Lire le guide',
      OPP_DELETED: 'Possibilité supprimé avec succès!',
      PROP_TITLE: 'Liste des propositions',
      PROP_NEW: 'Nouvelle proposition',
      PROP_SUBMIT: 'Soumettre votre proposition',
      PROP_WORK_ON: 'Ma proposition de travailler sur :',
      PROP_DEVELOPER: 'Développeur',
      PROP_COMPANY: 'Entreprise',
      PROP_PROPOSAL: 'Proposition',
      PROP_P1: 'Inclure les coordonnées de la personne qui propose de faire le travail et l\'information relative à la facturation.',
      PROP_P2: 'Si vous souhaitez que le paiement soit effectué à une entreprise, veuillez cocher la case ci-dessous et compléter l\'onglet Entreprise.',
      PROP_P3: 'Le paiement peut être émis à une entreprise',
      PROP_FNAME: 'Prénom',
      PROP_LNAME: 'Nom de faille',
      PROP_EMAIL: 'Adresse courriel',
      PROP_ADDRESS: 'Adresse',
      PROP_PHONE: 'Numéro de téléphone',
      PROP_LEGAL_COMPANY: 'Nom légal de l\'entreprise',
      PROP_MAILING_ADDRESS: 'Adresse postale de l\'entreprise',
      PROP_CONTACT_NAME: 'Nom du contact',
      PROP_CONTACT_PHONE: 'Numéro de tél. du contact',
      PROP_CONTACT_EMAIL: 'Adresse courriel du contact',
      PROP_DRAFT_PROPOSAL: 'Rédigez votre proposition ici. Assurez-vous de répondre aux <b>critères d\'évaluation de proposition</b> pour ce projet.',
      PROP_MY_PROPOSAL: 'Ma proposition',
      PROP_DELETE_MY: 'Supprimer ma proposition',
      PROP_WITHDRAW_MY: 'Retirer ma proposition',
      PROP_SUBMIT_MY: 'Soumettre ma proposition',
